    ...
    <div className="pt-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pb-12">
      <div className="animate-fade-in">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Mahalle bazında haftalık su tüketimi</p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-sm text-gray-600">Ortalama Su Tüketimi</h4>
        ...
        {selected && chartData.length > 0 && (
          <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100 chart-container">
            <h3 className="text-lg font-bold mb-4" style={{ color: '#111827' }}>Su Tüketim Trendi (m³)</h3>
            <div className="w-full h-[320px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData}>
                  ...
                  <Tooltip 
                    cursor={{ stroke: '#bbf7d0', strokeWidth: 1 }}
                    contentStyle={{
