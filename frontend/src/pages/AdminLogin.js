...
// import { useNavigate } from 'react-router-dom';  <-- BU SATIRI SİLDİK
...
const AdminLogin = () => {
  ...
  // const navigate = useNavigate(); <-- BU SATIRI SİLDİK
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // navigate('/yonetici'); <-- BU SATIRI SİLDİK
      // GEREK YOK: Çünkü giriş başarılı olunca App.js otomatik olarak sayfayı değiştirecek.
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[500px] bg-white/50 backdrop-blur-sm rounded-xl p-8 max-w-md mx-auto mt-10 shadow-xl border border-white/40">
