...
const AdminLogin = () => {
  ...
  return (
    // DEĞİŞİKLİK 1: Dış Katman (Wrapper) Eklendi
    // h-[calc(100vh-100px)] -> Ekran yüksekliğinden üstteki Header'ın payını (tahmini 100px) düşer ve kalanı kaplar.
    <div className="w-full flex items-center justify-center h-[calc(100vh-100px)]">
      
      {/* DEĞİŞİKLİK 2: 'mt-10' sınıfı buradan kaldırıldı. */}
