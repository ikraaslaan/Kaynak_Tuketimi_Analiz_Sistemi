      ...
      <div className="animate-fade-in-up">
        ...
        <div className="text-center mb-16 mt-8">
          ...
          <button 
            ...
            className="inline-flex items-center px-8 py-4 border border-transparent text-base font-medium rounded-full shadow-lg text-white bg-emerald-500 hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-transform duration-200 hover:scale-105"
          >
